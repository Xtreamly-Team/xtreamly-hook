...
\begin{itemize}
	\item \textbf{Profit Improvement:} On aggregate level, over \$1.31 million in additional value was recovered across the Uniswap liquidity positions when applying the hedging strategy. When standardized performance of each position to annualized yield (APY) the median improvement with hedging is 30.87\%.
	...
	\item \textbf{Avoided Liquidations:} Less than 1.2\% of all perpetuals were liquidated, confirming safety of leverage driven by Xtreamly forecasts.
\end{itemize}
