...
\smallskip
\textbf{Hedged Position}: The collateral is a fraction of the LP position to minimize negative impact to LP return. However, the leverage levels were changing.
...
\smallskip
\centering
\includegraphics[width=\columnwidth]{img/Position Hedge 935470_0x454d70a570e9a3d8749f752019cc66a9273e4669.png}
\captionof{figure}{Example of hedging LP position id: $_{935470_0x454d70a570e9a3d8749f752019cc66a9273e4669}$.}
\label{fig:935470_0x454d70a570e9a3d8749f752019cc66a9273e4669}
\justifying

\medskip
\textbf{Hedged Position}: The perpetual is active only at the beginning the LP position lifetime. The position was hedged only once because in later time the price did not reverse to beginning one.

\smallskip
\textbf{Return}: The hedged position reversed the return due to downgrading price and increased leverage. If hedging covered more time, the return would increase even further due to decreasing price. 

\smallskip
\textbf{Timeline}: Liquidation price is kept in safe levels despite x20 leverage.

\smallskip
\textbf{Payoff Value}: The expected return of hedged position is greater than original one across uniformly distributed price scenarios. 
